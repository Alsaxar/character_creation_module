...
def attack(char_name: str, char_class: str) -> str:
    """Calculate output damage from character."""
    ...
    return (f'{char_name} не выбрал класс, поэтому не играет')


def defence(char_name: str, char_class: str) -> str:
    """Calculate blocked input damage by character."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Calculate special attack damage from character."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Practice module with training cource."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Choose your class of character."""
